...
//  #define RTTY_ATTEMPTS        3              //number of times to repeat the broadcast, per transmission session
  ...
  #define APRS_CALLSIGN    "EA3BIG"             // Max 6 characters
 ...
 #define APRS_SSID             11               //set APRS_SSID to 9 for testing mode, 11 (or 12) for flight mode
  ...
  #define APRS_COMMENT     "Projecte Horus I"    //enter whatever you want (within reason)
  #define APRS_TELEM_INTERVAL  2                // How often to send telemetry packets.... every X transmissions.  Comment out to disable  
  #define SD_WRITE_TIME       1000              //how often to write to the SD card in milliseconds... don't go less than 1000, it's not a good idea.
  #define LED_TX              7                //on when HX1 is transmitting
  #define LED_OK              8                 //solid when all systems good. Flashing while acquiring GPS signal.
  #define LED_WARN            9                 //off when all systems good. Flashing solo when major error. Flashing with TX and OK when acquiring GPS signal.
  #define APRS_ENABLE         6                //PTT for the HX1
  #define APRS_DATA           3                 
...
//  #define USE_WATCHDOG                          //automatically reboot the Arduino if it hangs
  ...
  #define DHTPIN 2                             // what digital pin the humidity sensor is connected to. added in rev. 5
